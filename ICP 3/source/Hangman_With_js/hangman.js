...
var Hangman = (function () {
    ...
    Hangman.prototype.reset = function () {
        ...
        $('#hint').attr('src', "images/empty.png")
    };

    Hangman.prototype.showImage = function () {
        if (this.WORD == "PROGRAMMER") {
            $('#hint').attr('src', "images/programmer.jpeg")

        } else if (this.WORD == "BRAINSTORM") {
            $('#hint').attr('src', "images/brainstorm.png")

        } else if (this.WORD == "CREATIVE") {
            $('#hint').attr('src', "images/creative.jpeg")

        } else if (this.WORD == "LOLLIPOP") {
            $('#hint').attr('src', "images/lollypop.png")

        } else if (this.WORD == "CULTURE") {
            $('#hint').attr('src', "images/culture.jpeg")

        } else if (this.WORD == "RAZORSHARP") {
            $('#hint').attr('src', "images/razor.jpeg")

        } else if (this.WORD == "SCREWDRIVER") {
            $('#hint').attr('src', "images/screwgriver.jpeg")

        } else if (this.WORD == "TYPEWRITER") {
            $('#hint').attr('src', "images/typewriter.jpeg")
